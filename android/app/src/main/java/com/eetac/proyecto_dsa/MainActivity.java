...
public class MainActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btnUsuariosEvento = findViewById(R.id.btnUsuariosEvento);
        btnUsuariosEvento.setOnClickListener(v ->
                startActivity(new Intent(this, UsuariosEventoActivity.class))
        );
